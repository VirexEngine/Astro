...
const TOOLS = [
  { title: 'Daily Horoscope', desc: 'Read today\'s personalized forecast and energy score.', path: '/horoscopes/daily', icon: '🔮' },
  { title: 'Compatibility Checker', desc: 'Compare daily synastry aspects against your partner\'s placements.', path: '/free-tools/compatibility', icon: '💑' },
  { title: 'Free Kundli Chart', desc: 'Generate your full Vedic birth chart and planetary degrees.', path: '/free-tools/kundli', icon: '🕉️' },
  { title: 'Palmistry Explorer', desc: 'Inspect the lines, mounts, and symbols mapped on your hands.', path: '/services/palm-reading', icon: '✋' },
];
    ...
    <div className="w-full flex flex-col gap-6">
      <div className="text-center">
        <h3 className="text-base font-display font-medium text-white flex items-center justify-center gap-2">
          ...
          <span>Explore More Astrological Tools</span>
        </h3>
        <p className="text-xs text-white/50 mt-1">
          Continue your celestial journey with other GrahGanit features.
        </p>
      </div>
